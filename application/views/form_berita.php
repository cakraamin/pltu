<div class="topcolumn">
            <div class="logo"></div>
                            <ul  id="shortcut">   
                                ...
                                <li> <a href="<?php echo base_url();?>berita/daftar" title="Tambah Transaksi"> <img width="40px" alt="home" src="<?php echo base_url(); ?>assets/template/fingers/images/icon/shortcut/home.png"><strong>Daftar</strong> </a> </li>
