                              ...
                              <table class="display " id="static">
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td  align="left"><?=$this->arey->getJabatan($dt_kueri->id_jabatan)?></td>
                                    <td >          
                                      <span class="tip" >
                                      ...
                                      <span class="tip" >
                                          <a id="<?=$no?>" class="Delete"  name="Band ring" title="Delete Guru" href="<?=base_url()?>guru/hapus_guru/<?=$dt_kueri->id_guru?>"  >
