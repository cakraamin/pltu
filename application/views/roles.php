...
<div class="onecolumn" >
                    <div class="header">
                    <span ><span class="ico  gray spreadsheet"></span> Daftar Roles </span>
                    </div><!-- End header --> 
                    <div class=" clear"></div>
                    <div class="content" >                      
                              <table class="display static " id="static">
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td  align="left"><a href="<?=base_url()?>manajemen/set_role_permissions/<?=$dt_kueri->roleID?>">Permissions</a></td>
                                    <td >          
                                      <span class="tip" >
