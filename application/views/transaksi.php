...
<form action="<?php echo base_url();?>transaksi/all_transaksi/<?php echo $limbahs; ?>/<?php echo $units; ?>/<?php echo $userd; ?>/<?php echo $transporters; ?>/<?php echo $tanggal; ?>/<?php echo $sort_by; ?>/<?php echo $sort_order;?>/<?php echo $page; ?>" method="POST" enctype="multipart/form-data">
